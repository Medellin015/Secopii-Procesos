...
(function(){
  ...
  /* :id (columna de sistema de Socrata) como desempate => paginación estable:
     evita filas duplicadas/omitidas entre páginas cuando hay empates de fecha.
     Se dejan respaldos SIN :id por si el dataset no expone esa columna. */
  function orderCandidates(){
    if(!(F && F.fechaFirma)) return [":id", ""];
    var f=F.fechaFirma;
